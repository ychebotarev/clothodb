...
{
public:
    virtual void append_first_value(uint64_t* input) = 0;
    virtual void append_next_value(uint64_t* input) = 0;
};
...
private:
    __inline void store_delta_of_delta(int32_t delta_of_delta);
...
public:
    ...
    void append_first_value(uint64_t* input);
    void append_next_value(uint64_t* input);
...
private:
    __inline void store_delta_of_delta(int64_t deltaOfDelta);
